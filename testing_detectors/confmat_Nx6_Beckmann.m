%script per la creazione della matrice Nx6 per l'oggetto Beckmann
clear all
close all
...
%conseguenza.
order=["Beckmann_fronte" "Beckmann_fronte_steso","Beckmann_fronte_steso_capovolto","Beckmann_retro","Beckmann_retro_steso","Beckmann_retro_steso_capovolto","Balea","Denkmit","altro"];
figure
