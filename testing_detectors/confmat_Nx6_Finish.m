%script per la creazione della matrice Nx6 per l'oggetto Finish
clear all
close all
...
%conseguenza.
order=["finish_fronte","finish_fronte_steso","finish_fronte_steso_capovolto","finish_retro","finish_retro_steso","finish_retro_steso_capovolto","Balea","Beckmann","Denkmit","altro"];
A=[tp fp;fn 0];
figure
